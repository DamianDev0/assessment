const SKELETON_ROWS = ['sk-1', 'sk-2', 'sk-3', 'sk-4', 'sk-5', 'sk-6', 'sk-7', 'sk-8', 'sk-9', 'sk-10'] as const

export function JobsSkeleton() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-10 space-y-4" data-testid="jobs-skeleton">
      ...
      <div className="rounded-lg border border-border bg-card overflow-hidden">
        <div className="flex gap-6 px-4 py-3 border-b border-border">
          ...
          <div className="h-4 w-14 bg-muted rounded animate-pulse hidden xl:block" />
        ...
        {SKELETON_ROWS.map((id) => (
          <div key={id} className="flex items-center gap-6 px-4 py-3.5 border-b border-border last:border-b-0">
            <div className="h-4 w-36 bg-muted rounded animate-pulse" />
            <div className="h-4 w-32 bg-muted rounded animate-pulse hidden lg:block" />
            <div className="h-6 w-20 bg-muted rounded-full animate-pulse" />
            <div className="h-4 w-24 bg-muted rounded animate-pulse hidden md:block" />
            <div className="h-4 w-20 bg-muted rounded animate-pulse hidden lg:block" />
            <div className="h-4 w-16 bg-muted rounded animate-pulse hidden xl:block" />
            <div className="h-4 w-8 bg-muted rounded animate-pulse hidden xl:block" />
            <div className="h-4 w-20 bg-muted rounded animate-pulse hidden lg:block" />
